...
return [
    ...
    */
    ...
    'default' => filter_var(env('USE_LOCAL_DB', false), FILTER_VALIDATE_BOOLEAN) ? 'mariadb_local' : env('DB_CONNECTION', 'sqlite'),
    ...
    */
    ...
    'connections' => [
        ...
        'mariadb_local' => [
            'driver' => env('DB_DRIVER_LOCAL', 'mariadb'),
            ...
            'prefix' => '',
            'prefix_indexes' => true,
            'strict' => env('DB_STRICT_LOCAL', true),
            'engine' => null,
            'options' => extension_loaded('pdo_mysql') ? array_filter([
                (PHP_VERSION_ID >= 80500 ? Mysql::ATTR_SSL_CA : PDO::MYSQL_ATTR_SSL_CA) => env('MYSQL_ATTR_SSL_CA_LOCAL'),
            ]) : [],
        ],
