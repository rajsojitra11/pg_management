...
<form id="filter_form" class="rounded-lg border border-zinc-200 bg-white p-4 shadow-sm mb-4" onsubmit="return false;">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-3 lg:items-end">
        ...
        <div class="lg:col-span-3">
            <label class="block text-xs font-medium text-zinc-500 mb-1">{{ __('room::message.availability') }}</label>
            <select name="filter_availability" id="filterAvailability"
                ...
                <option value="available">{{ __('room::message.available') }}</option>
                <option value="full">{{ __('room::message.full') }}</option>
            </select>
        </div>
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            ...
                            <div>
                                <label class="block text-sm font-medium text-zinc-700 mb-1" for="bed_capacity">
                                    {{ __('room::message.bed_capacity') }}<span class="text-red-500"> *</span>
                                </label>
        ...
        table = initErpTable('#table', {
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.filter_availability = $('#filterAvailability').val();
                }
            },
            processing: true,
            serverSide: true,
