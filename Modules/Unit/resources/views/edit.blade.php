...
@section('breadcrumb', 'Home > Masters > Unit > Edit')

@section('content')
{{-- Page Header --}}
<div class="flex items-center justify-between mb-6">
    <h5 class="text-lg font-semibold text-zinc-700">{{ __('unit::message.edit') }}</h5>
    @can('unit-list')
        ...
        <div class="p-5">
            <div class="grid grid-cols-12 gap-4">
                ...
                <div class="col-span-12 sm:col-span-8">
                    ...
                    <input type="text" required name="name" id="unit_name" value="{{ $unit->name }}"
                ...
                <div class="col-span-12 sm:col-span-4">
                    ...
                    <input type="text" name="unit_value" id="unit_value" value="{{ $unit->unit_value }}"
                           class="w-full h-9 rounded-md border border-zinc-200 bg-white px-3 text-sm text-zinc-700 placeholder:text-zinc-400 focus:ring-1 focus:ring-zinc-500 focus:border-zinc-500">
                </div>
            </div>
        </div>
